...
// import { thsBot } from '../src';
// jest.setTimeout(5 * 60 * 1000);

// it's such a long time to test, comment this to make package push faster
// you'd better to write some js code works with this module to test if it is work fine
